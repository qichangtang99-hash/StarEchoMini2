...
# ============================================================
    ...
    # 递增计数器，下次text_area用新key强制刷新
    st.session_state.prompt_edit_counter = st.session_state.get("prompt_edit_counter", 0) + 1
    # 保存提示词步骤快照
...
# ============================================================
    ...
    # 可编辑的提示词（用计数器key避免Streamlit缓存导致value被忽略）
    prompt_text = prompt_result.get("prompt_text", "")
    _edit_key = f"edit_prompt_{st.session_state.get('prompt_edit_counter', 0)}"
